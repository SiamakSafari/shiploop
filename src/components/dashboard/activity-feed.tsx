...
const activityIcons: Record<ActivityType, { icon: typeof GitCommit; color: string; glow: string }> = {
  commit: { icon: GitCommit, color: "text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-800", glow: "" },
  revenue: { icon: DollarSign, color: "text-primary bg-gray-50 dark:bg-gray-900/30", glow: "" },
  signup: { icon: UserPlus, color: "text-gray-600 dark:text-gray-300 bg-gray-100 dark:bg-gray-800", glow: "" },
  launch: { icon: Rocket, color: "text-primary bg-gray-50 dark:bg-gray-900/30", glow: "" },
  milestone: { icon: Flag, color: "text-primary bg-gray-50 dark:bg-gray-900/30", glow: "" },
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 space-y-1 min-w-0">
                  <Caption className="text-gray-900 dark:text-gray-50 truncate font-semibold">
                    {item.title}
                  </Caption>
                  {item.description && (
                    <Micro className="text-gray-500 dark:text-gray-400 truncate font-medium">
                      {item.description}
                    </Micro>
                  )}
